<%@ Page Title="" Language="C#" MasterPageFile="~/ui/dashboard.Master" AutoEventWireup="true" CodeBehind="admin-list.aspx.cs" Inherits="CateringSystemWebApp.ui.admin_list" %>
        ...
        <div class="row">
            <div class="col-12 col-md-12" style="padding-left: 0px">
                <div class="table-responsive" style="border: none;">
                    <asp:GridView ID="gridCus" Width="100%" class="table table-hover table-bordered table-striped" Style="background: #ededfb;" OnRowDataBound="gridCus_OnRowDataBound" OnPageIndexChanging="gridCus_OnPageIndexChanging" AutoGenerateColumns="False" ShowHeader="True" ShowHeaderWhenEmpty="True" EmptyDataText="No Admin or Moderator Found" AllowPaging="True" PageSize="20" runat="server">
                        <Columns>
