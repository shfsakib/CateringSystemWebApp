<%@ Page Title="" Language="C#" MasterPageFile="~/ui/dashboard.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="CateringSystemWebApp.ui.profile" %>
        ...
        <div class="card-box pd-20 height-100-p mb-30">
            <div class="row align-items-center">
                <div class="col-12 col-lg-12 col-md-12">
                    ...
                    <div class="row" id="shopDiv" runat="server">
                        <div class="col-lg-2">
                            District :
                        </div>
                        <div class="col-lg-4">
                            <asp:Label ID="lbldistrict" runat="server" Text=""></asp:Label>
                            <asp:DropDownList ID="ddlDistrict" class="form-control wd mt2 select2" Visible="False" Style="border-right: 1px solid gainsboro; margin: 2px 0 0 0;" runat="server">
                        ...
                        <div class="col-lg-4">
                            ...
                            <asp:DropDownList ID="ddlThana" class="form-control wd mt2 select2" Visible="False" Style="border-right: 1px solid gainsboro; margin: 2px 0 0 0;" runat="server">
