...
namespace CateringSystemWebApp.URL
{
    public class Function
    {
        ...
        public string Connection = @"Data Source=.\local;Initial Catalog=CateringDb;Integrated Security=True";
        ...
        {
            HttpCookie cookie = new HttpCookie("Catering");
        ...
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies["Catering"];
            if (cookie == null || cookie?.Value == "")
            {
                cookie = null;
            }
