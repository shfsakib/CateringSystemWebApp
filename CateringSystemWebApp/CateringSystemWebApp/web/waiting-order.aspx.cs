...
{
    public partial class waiting_order : System.Web.UI.Page
    {
...
FROM            OrderList INNER JOIN
                         ...
                         Register AS Register_1 ON OrderList.CustId = Register_1.RegId WHERE OrderList.CustId='{func.UserIdCookie()}' AND OrderList.Status='A' ORDER By OrderList.OrderInvoice DESC";
